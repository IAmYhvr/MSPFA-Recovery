...
export default function GoogleActivityScanner() {
	...
	return (
		<main style={{ maxWidth: '700px' }}>
			...
			<p>
				Here's a bookmark that takes you to your Google activity page and allows you to recover any lost MSPFA data your Google account might have saved. To use it, follow these instructions:
			</p>
			<ol>
				<li>
					<p>
						Drag and drop the below button into your bookmarks bar:
					</p>
					<p style={{ marginLeft: '0.5em' }}>
						...
						>
							<span>Scan Google Activity</span>
						</a>
					</p>
					<p>
				...
				<li>
					Go to <a href={GOOGLE_ACTIVITY_URL} target="_blank" rel="noreferrer">{GOOGLE_ACTIVITY_URL}</a> <Icon icon="mdi:open-in-new" inline />.
				</li>
				<li>
					Click the bookmark while on that page, and follow what it says.
				</li>
			</ol>
			<p>
				<button onClick={useLinkTo(HistoryScanner)}>
					The activity scanner bookmark finished running and told me to return here. Proceed!
				</button>
			</p>
		</main>
	)
